...
const commonComponentLoaders = {
  ...
  'manager': () => import('@/pages/manager/home/index.vue'),
...
router.afterEach((to) => {
  ...
  if (authStore.isAuthenticated && authStore.user) {
    ...
    switch(userType) {
      ...
      case 'manager':
        prefetchRouteComponents(to.path, {
          'team': () => import('@/pages/manager/team/index.vue'),
          'projects': () => import('@/pages/manager/projects/index.vue'),
          'calendar': () => import('@/pages/manager/calendar/index.vue'),
        });
        break;
      case 'user':
        prefetchRouteComponents(to.path, {
