...
export const useAuthStore = defineStore("auth", () => {
  ...
  const hasPermission = (permission: string): boolean => {
    ...
    const rolePermissions: Record<UserRole, string[]> = {
      superadmin: ['all', 'user:read', 'user:write', 'user:delete', 'settings:read', 'settings:write', 'system:read', 'system:write', 'user:impersonate'],
      admin: ['user:read', 'user:write', 'settings:read', 'settings:write', 'team:read', 'team:write', 'project:read', 'project:write'],
      manager: ['user:read', 'team:read', 'team:write', 'project:read', 'project:write', 'calendar:read', 'calendar:write'],
      user: ['user:read', 'profile:read', 'profile:write', 'calendar:read']
    };
  ...
  async function login(credentials: LoginCredentials): Promise<void> {
    ...
    try {
      ...
      const userType = matchedUser?.user_type as keyof ReturnType<typeof getMockCredentials>;
